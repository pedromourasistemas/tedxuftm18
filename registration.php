<section id="registration" class="section registration">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <h3 class="section-title">Inscrições</h3>
            </div>
        </div>
        ...
        <div class="text-center mt20">
            <a href="http://www.sympla.com.br/tedxuftm-2018" target="_blank" class="btn btn-black" id="registration-submit-btn">Compre seu ingresso aqui</a>
        </div>
    </div>
</section>